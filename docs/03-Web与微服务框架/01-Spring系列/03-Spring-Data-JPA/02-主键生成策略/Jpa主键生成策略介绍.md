...
> 原文地址：https://blog.csdn.net/u012855229/article/details/114642223
...
[GeneratedValue](https://docs.oracle.com/javaee/7/api/javax/persistence/GeneratedValue.html) 是JPA主键生成策略中的一个非常重要的注解。它提供主键值生成策略的规范，可以与 [Id](https://docs.oracle.com/javaee/7/api/javax/persistence/Id.html) 注解一起应用于实体或映射[超类](https://so.csdn.net/so/search?q=超类&spm=1001.2101.3001.7020)的主键属性或字段；它只支持简单的主键，派生的主键不支持使用 。
